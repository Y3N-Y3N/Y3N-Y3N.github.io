...
The goal of this project was to gain hands-on experience with the foundations of web development by building a fully functional and responsive web application from scratch.

The project focuses on:
- Intuitive and functional UI design
- Semantic HTML structure
- Responsive CSS styling
- DOM manipulation with JavaScript
- Event handling and user interaction
- Modulising front-end code cleanly and effectively
